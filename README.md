...
| [🛢 SQL](Tech_task_SQL) | SQL queries for data extraction and analysis |
| [🐍 Python](Tech_task_Python) | Python scripts for data processing, functions, and logic |
| [🧮 Pandas](Tech_task_Pandas) | Data analysis using the pandas library |
